...
def initialize_spheroid_models(config,device = 'cuda',mode='train'):
...
def main(rank, world_size):
    ...
    config_path = r"config/config_conditional_spheroid.yaml"
    ...
    models_dict = initialize_spheroid_models(config,device,mode='train')
