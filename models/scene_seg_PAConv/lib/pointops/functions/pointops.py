...
try:
    ...
    to_load = [
        'pointops_api.cpp',
        'ballquery/ballquery_cuda.cpp',
        'ballquery/ballquery_cuda_kernel.cu)',
        'knnquery/knnquery_cuda.cpp',
        'knnquery/knnquery_cuda_kernel.cu',
        'knnquery_heap/knnquery_heap_cuda.cpp',
        'knnquery_heap/knnquery_heap_cuda_kernel.cu',
        'grouping/grouping_cuda.cpp',
        'grouping/grouping_cuda_kernel.cu',
        'grouping_int/grouping_int_cuda.cpp',
        'grouping_int/grouping_int_cuda_kernel.cu',
        'interpolation/interpolation_cuda.cpp',
        'interpolation/interpolation_cuda_kernel.cu',
        'sampling/sampling_cuda.cpp',
        'sampling/sampling_cuda_kernel.cu',
        'labelstat/labelstat_cuda.cpp',
        'labelstat/labelstat_cuda_kernel.cu',
        'featuredistribute/featuredistribute_cuda.cpp',
        'featuredistribute/featuredistribute_cuda_kernel.cu'
    ]

    to_load = [os.path.join(pointops_cuda_src,x).replace("/",os.sep) for x in to_load]




    pointops_cuda = load('pointops_cuda', to_load, build_directory=pointops_cuda_src, verbose=False)
